...
public class PlayerStats {
   ...
   public static void readingNamesAndScores(String[] names, int[] scores, String filename){
        try {
            ...
            System.err.println("File could not be found in reading readingNamesAndScores");
        }
